...
def get_Classic_args(log_dir):
    parser = argparse.ArgumentParser()

    parser.add_argument('--do_train', type=bool, default=True)
    parser.add_argument('--do_eval', type=bool, default=False)
    parser.add_argument('--do_verify', type=bool, default=False)
    ...
    parser.add_argument('--test_demos', type=int, default=10, help='Use 5 (seen demos to verify trained pol)')
    ...
    parser.add_argument('--g_coeff', type=float, default=10.0, help='Coefficient for the Goal Pred. loss')
    parser.add_argument('--ag_dim', type=int, default=3, help='Dimension for the achieved goal space')
    parser.add_argument('--alpha_dim', type=int, default=2)
