...
def get_ClassicVAE_args(log_dir):
    ...
    parser.add_argument('--test_demos', type=int, default=10, help='Use 10 (seen demos to verify trained pol)')
    ...
    parser.add_argument('--num_epochs', type=int, default=2, help='Recommended Use 500')
